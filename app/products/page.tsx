  ...
  return (
    <div className="w-full relative">
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex gap-2">
            <button
              type="button"
              onClick={exportToPDF}
              className="flex items-center gap-2 px-4 py-2 bg-[#141820] border border-white/8 text-gray-300 hover:text-white rounded-xl text-sm transition-all shadow-lg shadow-black/20"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[#f59e0b] hover:bg-[#d97706] text-white rounded-xl text-sm font-semibold transition-all shadow-lg shadow-[#f59e0b]/10"
            >
        ...
        {/* Tabel */}
        <div className="bg-[#141820] border border-white/5 rounded-2xl overflow-hidden shadow-xl shadow-black/40">
